...
class EmployeeBiometricRouteSecurityTest extends TestCase
{
    ...
    {
        $adminRoute = $this->findGetRoute('api/admin/employees/{employee}/fingerprints');
        ...
        $templateRoute = $this->findGetRoute('api/superadmin/employees/{employee}/fingerprints/templates');
    ...
    private function findGetRoute(string $uri)
    {
