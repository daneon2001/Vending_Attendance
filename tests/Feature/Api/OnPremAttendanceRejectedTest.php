...
class OnPremAttendanceRejectedTest extends OnPremApiTestCase
{
    public function test_rejects_event_with_invalid_unit(): void
    {
        ...
        $employeeId = $this->seedCollaborator(88003, $fixture['company_id'], $fixture['unit_id']);
    ...
    public function test_rejects_legacy_ambiguous_collaborator_without_operational_identifier(): void
    {
        $fixture = $this->seedDeviceFixture('CH-XOCH-004A', 'secret-rej-ambiguous');
        $this->seedCollaborator(99993, $fixture['company_id'], $fixture['unit_id'], [
            'id' => 1363,
            'name' => 'Empleado Interno 1363',
            'full_name' => 'Empleado Interno 1363',
        ]);
        $this->seedCollaborator(1363, $fixture['company_id'], $fixture['unit_id'], [
            'id' => 11,
        ...
        $payload = [
            ...
            'events' => [
                [
                    'local_event_id' => '44444444-4444-4444-4444-444444444445',
                    'collaborator_id' => 1363,
                    'punched_at_local' => '2026-02-18T10:11:00',
                    'timezone' => 'America/Mexico_City',
                    'punched_at_utc' => '2026-02-18T16:11:00Z',
                    'source' => 'FINGERPRINT',
                    'type_inout' => 'INOUT',
                ],
            ],
        ...
        $response->assertOk()
            ->assertJsonPath('received.0.status', 'REJECTED')
            ->assertJsonPath('received.0.reason', 'AMBIGUOUS_COLLABORATOR');
    }

    public function test_rejects_event_with_invalid_timestamp(): void
    {
        $fixture = $this->seedDeviceFixture('CH-XOCH-005', 'secret-rej-ts');
        $employeeId = $this->seedCollaborator(88005, $fixture['company_id'], $fixture['unit_id']);
    ...
    public function test_returns_batch_too_large_when_limit_is_exceeded(): void
    {
        ...
        $employeeId = $this->seedCollaborator(88006, $fixture['company_id'], $fixture['unit_id']);
    ...
    public function test_rejects_invalid_signature_with_code(): void
    {
        ...
        $employeeId = $this->seedCollaborator(88007, $fixture['company_id'], $fixture['unit_id']);
    ...
    public function test_rejects_nonce_replay_with_code(): void
    {
        ...
        $employeeId = $this->seedCollaborator(88008, $fixture['company_id'], $fixture['unit_id']);
    ...
    public function test_rejects_inactive_device_with_code(): void
    {
        ...
        $employeeId = $this->seedCollaborator(88010, $fixture['company_id'], $fixture['unit_id']);
    ...
    public function test_rejects_out_of_window_hmac_timestamp(): void
    {
        ...
        $employeeId = $this->seedCollaborator(88011, $fixture['company_id'], $fixture['unit_id']);
