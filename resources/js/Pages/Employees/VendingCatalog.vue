        ...
        <div class="mx-auto max-w-7xl space-y-6">
            ...
            <section v-if="isFortiaMock(fortia) || !fortia.real_api_ready || capabilities.sync" class="rounded-xl border border-app bg-surface p-4" aria-labelledby="fortia-heading">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <div><h2 id="fortia-heading" class="font-semibold text-app">Fortia<span v-if="isFortiaMock(fortia)"> · Fuente de prueba</span></h2><p v-if="!fortia.real_api_ready" class="mt-1 text-sm text-amber-700 dark:text-amber-300">La conexión productiva aún no está habilitada.</p></div>
